    ...
    $("#MainBtn3").click(function(){
        ...
        switch ($("#MainBtn3").html()){
            ...
            case "Stats":
                ...
                $("#MenuDescription").html('View your current stats and a breakdown of certain stats. <br>Stats equal to 0 are not shown.<br>&nbsp;<br><b>' + player.char.name + ' - ' + player.cloth.prefix + " " +player.cloth.name + ' - ' + player.weap.prefix + " " + player.weap.name + '</b>');
                ...
                // Remove displayed stats that are equal to 0
